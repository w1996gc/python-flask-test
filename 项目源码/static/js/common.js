...
window.onload = function(){
	...
	com.getData("../static/js/store.js",
		function(data){
...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "../static/images/"+stype+"/bg.png";

	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "../static/images/"+stype+"/dot.png";

	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "../static/images/"+stype+"/"+ com.args[i].img +".png";
	}

	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "../static/images/"+stype+"/r_box.png";

	document.getElementsByTagName("body")[0].style.background= "url(../static/images/"+stype+"/bg.jpg)";
